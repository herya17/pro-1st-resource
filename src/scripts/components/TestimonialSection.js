...
export default function Example() {
  return (
    <section className="border-t relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
        ...
        <figure className="mt-10">
          ...
          <figcaption className="mt-10">
            ...
            <div className="mt-4 flex items-center justify-center space-x-3 text-base">
              <div className="font-semibold text-gray-900">Heriyanto</div>
